<form v-on="submit: onSubmit">
    ...
    <div class="form-group">
        ...
        <p class="help-block">Specify if comments should be parsed as <a href="https://en.wikipedia.org/wiki/BBCode" target="_blank">BBCode</a> tags.</p>
    </div>
    ...
    <div class="form-group">
        ...
        <p class="help-block">Specify if content from <a href="http://s9etextformatter.readthedocs.org/Plugins/MediaEmbed/Sites/" target="_blank">media sites</a> should be embedded.</p>
    </div>
