<form v-on="submit: onSubmit">
    ...
    <div class="form-group">
        ...
        <p class="help-block">Specify for which users captcha is enabled. Make sure have <a href="http://docs.hazzardweb.com/ajax-comment-system-laravel/master/configuration#real-time">configured</a> a broadcast driver.</p>
    </div>
    ...
    <div class="form-group">
        ...
        <p class="help-block">Specify the default <a href="http://en.gravatar.com/site/implement/images/#default-image">Gravatar</a> imageset.</p>
    </div>
