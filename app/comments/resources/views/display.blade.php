...
<script type="text/x-template" id="comments-template">@include('comments::templates/comments')</script>
<script type="text/x-template" id="comment-template">@include('comments::templates/comment')</script>
<script type="text/x-template" id="form-template">@include('comments::templates/form')</script>
