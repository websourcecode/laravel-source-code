            ...
            <form v-on="submit: onSubmit">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" v-model="authorName" v-attr="readonly: user" v-disable="loading" id="author_name" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="author_email">Author Email</label>
                        <input type="text" v-model="authorEmail" v-attr="readonly: user" v-disable="loading" id="author_email" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="author_url">Author Url</label>
                        <input type="text" v-model="authorUrl" v-attr="readonly: user" v-disable="loading" id="author_url" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="status">Status</label>
                        <select v-model="status" v-disable="loading" id="status" class="form-control">
                            <template v-repeat="stat: config.statuses">
