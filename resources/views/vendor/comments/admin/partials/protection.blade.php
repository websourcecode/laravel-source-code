<form v-on="submit: onSubmit">
    ...
    <div class="form-group">
        ...
        <p class="help-block">Specify for which users captcha is enabled. Make sure reCAPTCHA is <a href="http://docs.hazzardweb.com/ajax-comment-system-laravel/master/configuration#recaptcha" target="_blank">configured</a>!</p>
    </div>
